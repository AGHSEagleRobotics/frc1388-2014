...
OI::OI() {
	...
	tuskButton = new JoystickButton(opStick, 1);
	tuskButton->WhileHeld(new TusksIn());
	feedInNow = new JoystickButton(opStick, 2);
	feedInNow->WhileHeld(new FeedIn());
	feedOutNow = new JoystickButton(opStick, 3);
	feedOutNow->WhileHeld(new FeedOut());
	restoreButton = new JoystickButton(opStick, 10);
	...
	cockShooterNow = new JoystickButton(rightDriverStick, 7);
	cockShooterNow->WhenPressed(new CockShooter());
	unloadShooterNow = new JoystickButton(rightDriverStick, 6);
