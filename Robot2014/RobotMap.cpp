...
RobotDrive* RobotMap::driveTrainMyDriveTrain = NULL;
...
void RobotMap::init() {
	...
	driveTrainMyDriveTrain = new RobotDrive(driveTrainLeftMotor, driveTrainRightMotor);
	
	driveTrainMyDriveTrain->SetSafetyEnabled(true);
        driveTrainMyDriveTrain->SetExpiration(0.1);
        driveTrainMyDriveTrain->SetSensitivity(0.5);
        driveTrainMyDriveTrain->SetMaxOutput(1.0);
