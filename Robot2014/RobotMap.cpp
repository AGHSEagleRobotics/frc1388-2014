...
AnalogChannel* RobotMap::clawPotentiometer1 = NULL;
...
void RobotMap::init() {
	...
	clawFrontLimitSwitch = new DigitalInput(1, 6);
	lw->AddSensor("Claw", "FrontLimitSwitch", clawFrontLimitSwitch);
	
	clawBackLimitSwitch = new DigitalInput(1, 5);
	lw->AddSensor("Claw", "BackLimitSwitch", clawBackLimitSwitch);
	
	clawPotentiometer1 = new AnalogChannel(1, 1);
	lw->AddSensor("Claw", "Potentiometer 1", clawPotentiometer1);
	
	clawArmMotor = new Talon(1, 3);
	...
	driveTrainRightEncoder = new Encoder(1, 7, 1, 8, false, Encoder::k4X);
